...
export const Shield = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <path
        fill="#CCD6DD"
        d="M33 3c-7-3-15-3-15-3S10 0 3 3C0 18 3 31 18 36c15-5 18-18 15-33"
      />
      <path
        fill="#55ACEE"
      ...
      <path
        fill="#269"
        d="M31.24 4.444C24.958 2.04 18.071 2 18 2v31.884c11.588-4.155 16.039-14.053 13.24-29.44"
      />
    </svg>
  );
};
